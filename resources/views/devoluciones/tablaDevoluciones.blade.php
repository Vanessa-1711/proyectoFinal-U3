...
@section('contenido')
    <div class="flex-none w-full px-3">
        <!-- Botón Agregar Devolución -->
        <div class="flex justify-end mb-4">
          <a class="buttonAgregar px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600" href="{{ route('devoluciones.create') }}">
                  ...
                  <div class="mx-4">
                    ...
                    <table id="myTable" class="items-center table-auto mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                      <thead class="align-bottom">
                        <tr>
                          <!-- Aquí se definen los encabezados de las columnas según tus datos -->
                      ...
                      <tbody>
                        ...
                        <tr>
                          <!-- Aquí se muestran los datos de cada devolución -->
    ...
    <!-- script de confirmación de borrado -->
