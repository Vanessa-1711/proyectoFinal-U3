...
<div class="flex-none w-full px-3">
    ...
    <div class="flex justify-end mb-4">
        <a class="buttonAgregar px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600" href="{{ route('subcategorias.create') }}">
                            ...
                            <table id="myTable" class="items-center table-auto mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <img class="text-xs font-semibold leading-tight dark:text-white  text-slate-400 rounded-xl" style="text-align: center ; margin-top: 10px;" src="{{ asset('uploads/'.$subcategoria->imagen) }}" width="100">
                                            </td>
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <p class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400" style="text-align: center ; margin-top: 10px;">{{ $subcategoria->nombre }}</p>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparen">
                                            <p class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400" style="text-align: center ; margin-top: 10px;">{{ $subcategoria->codigo }}</p>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <p class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400" style="text-align: center ; margin-top: 10px;">{{ $subcategoria->descripcion }}</p>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <p class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400" style="text-align: center ; margin-top: 10px;">{{ $subcategoria->creador->name }}</p>
                                        </td>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent" style="width: 90px;">
                                            <div style="display: flex; align-items: center; justify-content: left;">
                                                <!-- Primer botón - Editar -->
                                                <a href="{{ route('subcategorias.edit', $subcategoria->id) }}" class="buttonEditar text-blue-500 hover:text-blue-700 rounded-full bg-blue-500 text-white p-2" style="margin-right: 5px;">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <!-- Segundo botón - Eliminar -->
                                                <form action="{{ route('subcategorias.destroy', $subcategoria->id) }}" method="POST" id="deleteForm-{{ $subcategoria->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" style="color: white; background-color: red;" class="buttonBorrar rounded-full p-2" onclick="confirmDelete({{ $subcategoria->id }})">
