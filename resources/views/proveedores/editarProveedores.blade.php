      ...
      <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
        ...
        <div class="flex-auto px-0 pt-0 pb-2">
          <div class="p-6">
            ...
            <form action="{{ route('proveedores.update', $proveedor->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="nombre" name="nombre" type="text" placeholder="Nombre" value="{{ old('nombre', $proveedor->nombre) }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="codigo" name="codigo" type="text" placeholder="Código" value="{{ old('codigo', $proveedor->codigo) }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="telefono" name="telefono" type="text" placeholder="Teléfono" value="{{ old('telefono', $proveedor->telefono) }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="correo" name="correo" type="email" placeholder="Correo" value="{{ old('correo', $proveedor->correo) }}">
                </div>
