                                ...
                                <form id="csv-upload-form" class="p-4 space-y-4" action="{{ route('importar.store') }}"
                                    ...
                                    <div>
                                        <button type="submit" id="upload-button"
                                            class="buttonAgregar px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Subir
                                            CSV</button>
                                    </div>
                                    {{-- <div class="flex justify-end mb-4">
                                        <a class="buttonAgregar px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
